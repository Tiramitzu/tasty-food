<?php $__env->startSection("title", "Ubah Berita"); ?>
        ...
        <div class="flex flex-col justify-center items-center py-8 px-6 mx-auto md:h-screen lg:py-0">
            <div class="w-full bg-white rounded-lg shadow sm:max-w-md md:mt-0 xl:p-0">
                ...
                <div class="p-6 space-y-4 sm:p-8 md:space-y-6">
                    <form class="flex flex-col gap-4" action="<?php echo e(route("berita.update", $berita->slug)); ?>" method="POST"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <input type="title" name="title" id="title"
                                ...
                                placeholder="judul" required="" value="<?php echo e($berita->judul); ?>">
                        </div>
                        <div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <textarea type="content" name="content" id="content" placeholder="isi" cols="40" rows="10"
                                ...
                                required=""><?php echo e($berita->isi); ?></textarea>
                        </div>
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/berita/edit.blade.php ENDPATH**/ ?>