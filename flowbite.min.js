							...
							return (
								...
								function () {
									Object.keys(e.elements).forEach(function (t) {
										var n = e.elements[t],
											o = e.attributes[t] || {},
											r = Object.keys(e.styles.hasOwnProperty(t) ? e.styles[t] : i[t]).reduce(function (
												t,
												e
											) {
												return (t[e] = ""), t;
						...
						return (
							...
							f
								...
								: Object.assign(
										{},
										S,
										(((e = {})[x] = L ? b + "px" : ""), (e[O] = E ? y + "px" : ""), (e.transform = ""), e)
								  )
						);
					}
					var it = {
							...
							: ht(
									(function (t) {
										var e,
											...
											c = -n.scrollTop;
										return (
											"rtl" === R(o || i).direction && (a += I(i.clientWidth, o ? o.clientWidth : 0) - r),
