                ...
                <div class="flex flex-col gap-3 lg:w-1/2">
                    <div class="rounded-2xl">
                        <input type="text" placeholder="Subject" name="subject"
                            class="p-3 w-full text-lg rounded-2xl border-2 @error("subject") border-red-500 @enderror border-black focus:outline-none h-[6rem]">
                        @error("subject")
                    ...
                    <div class="rounded-2xl">
                        <input type="text" placeholder="Name" name="name"
                            class="p-3 w-full text-lg rounded-2xl border-2 @error("name") border-red-500 @enderror border-black focus:outline-none h-[6rem]">
                        @error("name")
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="rounded-2xl">
                        <input type="email" placeholder="Email" name="email"
                            class="p-3 w-full text-lg rounded-2xl border-2 @error("email") border-red-500 @enderror border-black focus:outline-none h-[6rem]">
                        @error("email")
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="lg:w-1/2">
                    <div class="w-full rounded-2xl">
                        <textarea placeholder="Message" name="message"
                            class="p-8 w-full text-lg rounded-2xl border-2 @error("message") border-red-500 @enderror border-black resize-none focus:outline-none h-[312px]"></textarea>
                        @error("message")
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
                    </div>
    ...
    <section class="py-4 px-10 lg:px-20" id="contact">
        <div class="flex flex-col justify-between md:flex-row">
            <div class="flex flex-row gap-2 items-center mb-4 md:flex-col">
                <img class="w-12 h-12 lg:w-28 lg:h-28" src="{{ asset("icons/Group-66.png") }}" alt="">
                ...
                <p id="email" class="text-sm tracking-wide lg:text-xl">{!! $kontak["email"] !!}</p>
                @auth
                    <textarea name="email_input" id="email_input" cols="30" rows="2" class="hidden"></textarea>
                @endauth
            </div>
            <div class="flex flex-row gap-2 items-center mb-4 md:flex-col">
                <img class="w-12 h-12 lg:w-28 lg:h-28" src="{{ asset("icons/Group-67.png") }}" alt="">
                <div class="flex flex-row gap-2 items-center">
                ...
                <p id="phone" class="text-sm tracking-wide lg:text-xl">{!! $kontak["phone"] !!}</p>
                @auth
                    <textarea name="phone_input" id="phone_input" cols="30" rows="2" class="hidden"></textarea>
                @endauth
            </div>
            <div class="flex flex-row gap-2 items-center mb-4 md:flex-col">
                <img class="w-12 h-12 lg:w-28 lg:h-28" src="{{ asset("icons/Group-68.png") }}" alt="">
                <div class="flex flex-row gap-2 items-center">
                ...
                <p id="location" class="text-sm tracking-wide lg:text-xl">{!! $kontak["location"] !!}</p>
                @auth
