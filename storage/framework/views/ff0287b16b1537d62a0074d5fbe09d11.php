        ...
        <div class="flex flex-col flex-1 justify-center items-center px-4 h-full sm:px-0">
            <div class="flex w-full bg-white rounded-lg shadow-lg sm:mx-0 sm:w-3/4 lg:w-1/2" style="height: 500px">
                <div class="flex flex-col p-4 w-full md:w-1/2">
                    <div class="flex flex-col flex-1 justify-center mb-8">
                        ...
                        <div class="mt-4 w-full">
                            <form class="mx-auto w-3/4 form-horizontal" method="POST" action="<?php echo e(route("proc_login")); ?>">
                                <?php echo csrf_field(); ?>
                ...
                <div class="hidden rounded-r-lg md:block md:w-1/2"
                    style="background: url('<?php echo e(asset("assets/brooke-lark-nBtmglfY0HU-unsplash.jpg")); ?>'); background-size: cover; background-position: center center;">
                </div>
            </div>
        </div>
    </div>
    <?php if($message = Session::get("error") || $errors->any()): ?>
        <div id="toast-danger"
